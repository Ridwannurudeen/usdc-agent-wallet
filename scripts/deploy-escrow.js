...
async function main() {
  ...
  console.log(`\n🚀 Deploying AgentEscrow to ${networkName}...\n`);
  ...
  const escrow = await AgentEscrow.deploy(usdcAddress);
  await escrow.deployed();

  console.log("\n✅ AgentEscrow deployed to:", escrow.address);
  ...
  if (networkName !== "hardhat" && networkName !== "localhost") {
    ...
    try {
      ...
      console.log(`npx hardhat verify --network ${networkName} ${escrow.address} ${usdcAddress}`);
    }
  }
